                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-edit"></i> 药品管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="admin-med_type" class="active">药品类别管理</a></li>
                    </ul>
                  </li>
            ...
            <div class="col-md-8 col-sm-8 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <div class="dashboard-widget-content">
       	        	<div class="col-sm-12">
				    	<s:if test="#request.category == null || #request.category.size() == 0">
					               药品类型为空，请先添加类型！
					    </s:if>
					    <s:else>
					        <table class="table">
						        ...
						        <s:iterator value="#request.category">
						          <tr>
						            ...
						            <td>
						                ...
						                <em>|</em>
						                <a href="admin-deleteType?id=${id }">删除</a>
						            </td>
						          </tr>
									  ...
									  <div class="modal-dialog" role="document">
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
										      <form class="form-horizontal" action="admin-modifyType" method="post">
										        <div class="form-group">
													<label class="control-label">类型名称：</label>
										        	<div>
													  <input name="categoryName" class="form-control" value="${categoryName }" disabled>
