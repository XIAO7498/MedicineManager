            ...
            <li><a><i class="fa fa-edit"></i> 药品管理 <span class="fa fa-chevron-down"></span></a>
                  ...
                  <s:if test="#session.role == 'superAdmin'">
                    <li><a><i class="fa fa-desktop"></i> 系统管理 <span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu">
                        <li><a href="admin-admin_account" class="active">管理员账号管理</a></li>
					        ...
					        <s:iterator value="#request.admin">
					          <tr>
					            ...
					            <td>
					              ...
					              <em>|</em>
					              <a href="admin-deleteAdmin?id=${id }" class="delete">删除</a>
								  ...
								  <div class="modal-dialog" role="document">
								    <div class="modal-content">
								      ...
								      <div class="modal-body">
									      <form class="form-horizontal" action="admin-modifyAdmin" method="post">
									        <div class="form-group">
												<label class="control-label">管理员ID：</label>
									        	<div>
												  <input name="adminID" class="form-control" value="${adminID }" disabled="disabled">
    ...
    <script type="text/javascript">
	    $(function(){
			...
			$(".delete").click(function(){
				var adminID = $(this).next(":hidden").val();
				var id = $(this).next().next(":hidden").val();
				if(id != 1){
					var flag = confirm("确定要删除" + adminID + "的信息吗?");
					if(flag){
